...
const API_ENDPOINTS = {
  ...
  DEVICES: {
    ...
    GET_TEMPERATURE: (id) => `${API_BASE_URL}/api/devices/${id}/temperature-humidity`,
    GET_SOIL_MOISTURE: (id) => `${API_BASE_URL}/api/devices/${id}/soil-moisture`,
    GET_PUMP_WATER: (id) => `${API_BASE_URL}/api/devices/${id}/pump-water`,
